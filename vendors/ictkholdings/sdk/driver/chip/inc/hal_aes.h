...
typedef enum {
    ...
    HAL_AES_STATUS_INVALID_BLOCK_SIZE = -3,
    HAL_AES_STATUS_NOT_ENOUGH_OUTPUT_BUFFER = -4,
    HAL_AES_STATUS_INVALID_KEY_LENGTH = -5,
    HAL_AES_STATUS_INVALID_KEY_SOURCE = -6,
    HAL_AES_STATUS_INVALID_MODE = -7,
    HAL_AES_STATUS_ENCRYPT_FAIL = -8,
    HAL_AES_STATUS_DECRYPT_FAIL = -9,
