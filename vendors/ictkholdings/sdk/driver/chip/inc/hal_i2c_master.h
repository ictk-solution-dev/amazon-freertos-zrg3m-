...
#ifdef HAL_I2C_SUPPORT_HIGH_SPEED
...
/**
 * @brief This function sends data to and then receives data from I2C slave in extended DMA mode.
 *  This function returns immediately after configuring the hardware registers. For more details of extended DMA mode, see
 *  extended DMA mode in @ref HAL_I2C_Features_Chapter chapter. For details about the transaction length and transaction waveform pattern, see @ref HAL_I2C_Transaction_Pattern_Chapter chapter.
 *  Note, not all I2C masters support DMA mode. For more details about DMA mode, see #hal_i2c_port_t.
 * @param[in] i2c_port is the I2C master port number. The value is defined in #hal_i2c_port_t.
