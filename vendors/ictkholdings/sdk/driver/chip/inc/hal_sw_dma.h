 ...
 *      |h_size/burst                   |single                 |4-beat burst       |
 *      |---------------------------------------------------------------------------|
 *      |byte (h_size = 0)              |1 byte align           |1 bytes align      |
 *      |half-word (h_size = 1)         |2 bytes align          |2 bytes align      |
 *      |word (h_size = 2)              |4 bytes align          |4 bytes align      |
 *      |---------------------------------------------------------------------------|
>>>>>>> geneva-dev-maindev-ag3335-E1BringUp_20191217_090722
