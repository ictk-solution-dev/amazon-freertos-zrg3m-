...
int _i2c_init(void)
{
    ...
    ret = hal_gpio_init(HAL_GPIO_27);    /// SCL
    ret = hal_gpio_init(HAL_GPIO_28);    /// SDA
    ret_pinmux_status = hal_pinmux_set_function(HAL_GPIO_27, HAL_GPIO_27_GPIO27); // Set the pin to GPIO mode.
    ret_pinmux_status = hal_pinmux_set_function(HAL_GPIO_28, HAL_GPIO_28_GPIO28); // Set the pin to GPIO mode.

    ret = hal_gpio_set_direction(HAL_GPIO_27, HAL_GPIO_DIRECTION_OUTPUT);
    ret = hal_gpio_set_direction(HAL_GPIO_28, HAL_GPIO_DIRECTION_OUTPUT);
