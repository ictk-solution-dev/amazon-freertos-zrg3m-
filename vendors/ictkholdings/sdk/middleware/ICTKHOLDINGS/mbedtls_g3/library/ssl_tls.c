                                 ...
                                 int endpoint, int transport, int preset )
{
    ...
    switch( preset )
    {
        ...
        default:
            ...
            conf->ciphersuite_list[MBEDTLS_SSL_MINOR_VERSION_0] = mbedtls_ssl_list_ciphersuites();
            conf->ciphersuite_list[MBEDTLS_SSL_MINOR_VERSION_1] = mbedtls_ssl_list_ciphersuites();
            conf->ciphersuite_list[MBEDTLS_SSL_MINOR_VERSION_2] = mbedtls_ssl_list_ciphersuites();
            conf->ciphersuite_list[MBEDTLS_SSL_MINOR_VERSION_3] = mbedtls_ssl_list_ciphersuites();
                                   //mbedtls_ssl_list_ciphersuites();

#ifdef ICTK_TLS
            if(cipher_flag == 1)
              retVal = set_support_ciphersuite(MBEDTLS_TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256/*0xC0AC/*0xC02B*//*0xC023/*MBEDTLS_SSL_CIPHERSUITES*/);
            else
              retVal = set_support_ciphersuite(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256/*0xC0AC/*0xC02B*//*0xC023/*MBEDTLS_SSL_CIPHERSUITES*/);
#endif
