...
/* The HW data path, CM4->PSE, can retain about 8 PSE page size data. To avoid keeping sending
  * data to PSE when PSE is about to be full, reserve 8 PSE pages in the HIF PSE quota.
  */
#define DEFAULT_RSV_PSE_HIF_PAGE_NUM            8
#if (PRODUCT_VERSION == 7687 || PRODUCT_VERSION == 7697)
#define DEFAULT_N9_PSE_PAGE_QUOTA               (910 - DEFAULT_RSV_PSE_HIF_PAGE_NUM)
#elif (PRODUCT_VERSION == 7698 || PRODUCT_VERSION == 7686 || PRODUCT_VERSION == 7682 || PRODUCT_VERSION == 5932)
#define DEFAULT_N9_PSE_PAGE_QUOTA               (260 - DEFAULT_RSV_PSE_HIF_PAGE_NUM)
#else
// reserved for the future chipset
#endif
