...
typedef struct {
    ...
    uint8_t forwarding_zero_copy; /*Feature was added to improve intra bss forwarding throughput. (always set), Internal use.  */
    ...
    // END TODO, need N9 update the profile together
    uint8_t sta_pmf_capability;
    uint8_t sta_csa_enable;
