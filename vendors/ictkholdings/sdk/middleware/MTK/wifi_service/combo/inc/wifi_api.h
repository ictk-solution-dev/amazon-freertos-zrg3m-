...
* It refer ISO/IEC 3166-1, Codes for the representation of names of countries and their subdivisions�Part 1: Country codes.
...
* two APIs,  #wifi_config_set_pmk() and #wifi_config_set_wpa_psk_key(), only the last one will take effect.
...
* and call #wifi_config_set_wpa_psk_key, the setting PMK will be applied. This API is now only supported by MT7687/7697.
*
* @return >=0 the operation completed successfully, <0 the operation failed.
*/
