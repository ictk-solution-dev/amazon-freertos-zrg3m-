...
typedef enum {
    ...
    WIFI_COMMAND_ID_EXTENSION_IS_AP_CONNECTED = 0x33,         /**< 0x33 (Set/Quary) ,for c4sp*/    
    WIFI_COMMAND_ID_EXTENSION_IS_AP_IP_READY = 0x34,          /**< 0x34 (Set/Quary) ,for c4sp*/    
    WIFI_COMMAND_ID_EXTENSION_IS_IP_READY = 0x35,          /**< 0x35 (Set/Quary) */    
    ...
    WIFI_COMMAND_ID_EXTENSION_AP_SMART_ON_OFF   = 0x39,        /**< 0x39 (Set/Query) */
    ...
    WIFI_COMMAND_ID_EXTENSION_SELECT_ANT        = 0x3C,        /**< 0x3C (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_GET_RATE1         = 0x3D,        /**< 0x3D (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_GET_SNR           = 0x3E,        /**< 0x3E (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_RETRY_COUNT       = 0x3F,        /**< 0x3F (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_FIXED_RATE_ENABLE = 0x40,        /**< 0x40 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_STA_CSA           = 0x41,        /**< 0x41 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_PMF_CAPABILITY    = 0x43,        /**< 0x43 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_ASSOC             = 0x44,        /**< 0x44 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_GET_TEMPERATURE   = 0x45,        /**< 0x45 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_BMC_FILTER        = 0x46,        /**< 0x46 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_BCN_LOST          = 0x47,        /**< 0x47 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_EARLY_TBTT        = 0x48,        /**< 0x48 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_PS_DEBUG          = 0x49,        /**< 0x49 (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_PS_DYNMIC         = 0x4A,        /**< 0x4A (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_PS_STEP_PRETBBT   = 0x4B,        /**< 0x4B (Set/Query) */
    WIFI_COMMAND_ID_EXTENSION_PMF_CONFIG        = 0x4C,        /**< 0x4C (Set/Query) */
...
typedef struct _txd_param {
    ...
    uint8_t seq_by_user;    /* 0:by hw, 1: by user, set packet sequence by the user or hw not support mt7687/97*/
    uint8_t reserved[1];    /* reserverd */
} txd_param_t;
...
int32_t wifi_inband_pmf_capability(uint8_t flag_set, uint8_t  *capability);

#if 1 //for library release, we should keep it true
/* WPA3 SAE AUTHENTICATE data structure send to N9 */
typedef struct inband_cmd_ext_associate{
    uint8_t auth_alg;
    uint8_t ie_len;
    /* followed by ie_len bytes of ie */
}inband_cmd_extern_assoc_t;

int32_t wifi_inband_extern_assoc(uint8_t auth_alg, const uint8_t *ie, uint8_t ie_len);
#endif
#if 1//def MTK_WIFI_STA_CSA_ENABLE
int32_t wifi_inband_sta_csa(uint8_t set, uint8_t *value);
#endif
