...
typedef struct __wifi_init_callback {
    ...
    int32_t (*wifi_get_wmmcapble_enable)(uint8_t inf_num);
    uint8_t (*wifi_get_max_retry_count)(void);
    uint8_t (*wifi_get_pmf_capability)(void);
    int8_t  (*wifi_get_sta_csa_cfg)(uint8_t* enable);
    int16_t (*wifi_get_cca_threshold)(void);
    uint16_t (*wifi_get_sta_ctl_frame_rate_sets)(void);
} wifi_init_callback;
...
int8_t wifi_get_sta_csa_cfg(uint8_t* enable);
int16_t wifi_get_user_cca_threshold(void);
