...
void * queue_hal_pbuf_alloc_boson(unsigned short length);
unsigned char queue_hal_pbuf_free_boson(void *p);
void queue_hal_enqueue_rx_pkt_lwip(void *p, void *netif);
