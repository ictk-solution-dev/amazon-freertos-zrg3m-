...
typedef struct {
    ...
    uint8_t seq_by_user;                    /* 0:by hw, 1: by user, set packet sequence by the user or hw */
    uint8_t reserved[1];                    /* reserverd[0]:*/
} txd_param_setting_t;
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
* @note  1. Only MT7682 / 7686 / 5932 support this
*        2. Do not use this API when WMM(802.11e QoS) enable, this API will make wifi driver put all kinds of business into AC3 queue
*/
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
* @note Only MT7682 / 7686 / 5932 support this
*/
...
/**
* @brief This function do wps reg pin.

* @param[in] cmd is  the cmd string.
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support WPS mode
*/
int wifi_wps_reg_pin(char *cmd);

/**
* @brief This function is set wps crdential handler.
...
** @note current only support WPS mode
*/
int wifi_config_set_wps_crdential_handler(char *cmd);
...
/**
* @brief This function used for entering test mode of N9.
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, this API can not be used alone, must used with #wifi_config_set_contiues_tx(), please refer to #wifi_config_set_contiues_tx() for detail usage. 
*/
int32_t wifi_config_set_test_mode(void);


/**
* @brief This function used for get cca threshold.
*
* @param[in] start: 1: start,0: stop
*
* @param[in] modulation: 0: CCK, 1: OFDM, 2: HT MM, 3: HT GF
*
* @param[in] bw: 0: 20MHz,1: 40MHz
*
* @param[in] channel: 1~14
*
* @param[in] rate: 
*                       modulation / HT      =  n of MCS_n
*                       modulation / CCK     =  0 for   1 Mbps Long Preamble
*                                           =  1 for   2 Mbps Long Preamble
*                                           =  2 for 5.5 Mbps Long Preamble
*                                           =  3 for  11 Mbps Long Preamble
*                                           =  5 for   2 Mbps Short Preamble
*                                           =  6 for 5.5 Mbps Short Preamble
*                                           =  7 for  11 Mbps Short Preamble
*                       modulation / OFDM    = 11 for   6 Mbps
*                                           =  1 for   9 Mbps
*                                           = 15 for  12 Mbps
*                                           = 14 for  18 Mbps
*                                           =  9 for  24 Mbps
...
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, #wifi_config_set_test_mode must be called first before start continues TX. This only support to start continues TX, if you want to stop continues TX to enter normal mode, you need to reboot.
*        Start continues TX must follow the steps below:
*        1. invoke #wifi_config_set_test_mode() to enter test mode;
*        2. invoke #wifi_config_set_channel() to configure the channel you want to run in continues TX;
*        3. send 8 normal packets with the data rate you want to run in continues TX, you can invoke #wifi_connection_send_raw_packet_advanced() as example;
*        4. invoke #wifi_config_set_contiues_tx() to start continues TX.
*/
int32_t wifi_config_set_contiues_tx(uint8_t start, uint8_t modulation, uint8_t bw, uint8_t channel, uint8_t rate);


#ifdef MTK_WIFI_SW_ANTENNA_DIVERSITY
/**
* @brief This function sw antenna diversity, select antenna number.
*
* @param[in] ant_num: select the current antenna index
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_current_antenna_diversity_num(uint8_t ant_num);

/**
* @brief This function sw antenna diversity, get antenna number.
*
* @param[out] ant_num: indicate the current antenna index
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_current_antenna_diversity_num(uint8_t *ant_num);

/**
* @brief This function sw antenna diversity, enable or disalbe this feature.
*
...
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_antenna_diversity_onff(uint8_t onoff);

/**
* @brief This function sw antenna diversity, get current on/off state.
*
...
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_antenna_diversity_onff(uint8_t *onoff);

/**
* @brief This function sw antenna diversity, set antenna diversity period timer.
*
* @param[in] minute: set the period of anteena diversity,  the unit is minute
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_antenna_diversity_timer_period(uint8_t minute);


/**
* @brief This function sw antenna diversity, get antenna diversity period timer.
*
* @param[in] minute: get current period of anteena diversity,  the unit is minute
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_antenna_diversity_timer_period(uint8_t *minute);


/**
* @brief This function sw antenna diversity, set antenna diversity short period timer.
*
* @param[in] period: set short period timer of anteena diversity,  the unit is minute.
* if current antenna not start for some reasons, will start short period timer for next antenna diversity
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_antenna_diversity_short_period(uint8_t period);


/**
* @brief This function sw antenna diversity, get antenna diversity short period timer.
*
* @param[out] period: get short period timer of anteena diversity,  the unit is minute.
* if current antenna not start for some reasons, will start short period timer for next antenna diversity
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_antenna_diversity_short_period(uint8_t *period);

/**
* @brief This function sw antenna diversity, set antenna diversity rssi threshold.
*  if ant2_rssi - ant1_rssi > threshold, will switch to ant2
* @param[in] threshold: set antenna diversity  rssi threshold
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_antenna_diversity_rssi_threshold(uint8_t threshold);

/**
* @brief This function sw antenna diversity, get antenna diversity rssi threshold.
*  if ant2_rssi - ant1_rssi > threshold, will switch to ant2
* @param[out] threshold: get antenna diversity  rssi threshold
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_antenna_diversity_rssi_threshold(uint8_t *threshold);


/**
* @brief This function sw antenna diversity, set antenna diversity beacon n num.
*
* @param[in] num: set antenna diversity  beacon n num
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_antenna_diversity_beacon_n_num(uint8_t num);

/**
* @brief This function sw antenna diversity, get antenna diversity beacon n num.
*
* @param[out] num: set antenna diversity  beacon n num
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_antenna_diversity_beacon_n_num(uint8_t *num);

/**
* @brief This function sw antenna diversity, set antenna diversity beacon t num.
*
* @param[in] num: set antenna diversity  beacon t num
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_antenna_diversity_beacon_t_num(uint8_t num);

/**
* @brief This function sw antenna diversity, get antenna diversity beacon t num.
*
* @param[out] num: set antenna diversity  beacon t num
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_antenna_diversity_beacon_t_num(uint8_t *num);

/**
* @brief This function sw antenna diversity, set upper idle state.
* if upper didnot idle, will not do sw antenna diversity
*
* @param[in] flag: 0: not idle, 1: idle
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_antenna_diversity_idle_flag(uint8_t flag);

/**
* @brief This function sw antenna diversity, get upper idle state.
* if upper didnot idle, will not do sw antenna diversity
*
* @param[out] flag: 0: not idle, 1: idle
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_antenna_diversity_idle_flag(uint8_t *flag);

/**
* @brief This function sw antenna diversity, set which gpio to control which antenna.
*
* @param[in] ant_num: indicate the index of antenna
* @param[in] gpio_num: indicate the index of gpio
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_set_antenna_diversity_div_gpio(uint8_t ant_num, uint8_t gpio_num);


/**
* @brief This function sw antenna diversity, get the gpio index
*  which is used to control the specified antenna.
*
* @param[in] ant_num: indicate the index of antenna
* @param[out] gpio_num: indicate the index of gpio
*
* @return  >=0 the operation completed successfully, <0 the operation failed.
*
** @note current only support 7682/7686/7698, And only for internal debugging use
*/
int32_t wifi_config_get_antenna_diversity_gpio(uint8_t ant_num, uint8_t *gpio_num);
