...
/**
* @brief Example of configiure Continues TX
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:   wifi config set conti_tx <start:1,stop:0> <Modulation> <BW> <Ctrl CH> <Rate>
*
...
* \n <b>cli_example</b>: wifi config set conti_tx 1 2 0 1 7
* \n <b>cli_note</b>:    This only support to start continues TX, if you want to stop continues TX to enter normal mode, you need to reboot.
*
*/
uint8_t wifi_config_set_conti_tx_ex(uint8_t len,char * param [ ]);

#ifdef MTK_WIFI_SW_ANTENNA_DIVERSITY
/**
* @brief Example of set antenna on/off.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:   wifi config set ant_diversity_on <on/off>
* \n <b>cli_param</b>:   on/off:  0: off;  1: on
*
* \n <b>cli_example</b>: wifi config set ant_num 1
* \n <b>cli_note</b>: set sw antenna diversity feature on
*
*/
uint8_t wifi_config_set_antenna_diversity_onff_ex(uint8_t len, char *param[]);

/**
* @brief Example of get antenna on/off.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get ant_diversity_on <on/off>
* \n <b>output</b>:        on_off:  0: off;  1: on
*
* \n <b>cli_example</b>:   wifi config get ant_num
* \n <b>cli_note</b>:      return antenna diversity feature on/off.
*
*/
uint8_t wifi_config_get_antenna_diversity_onff_ex(uint8_t len, char *param[]);

/**
* @brief Example of set switch antenna period.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:  wifi config set ant_timer_period <value>
* \n <b>cli_param</b>:   value:  the value of antenna switch period
*
* \n <b>cli_example</b>: wifi config set ant_timer_period 2
* \n <b>cli_note</b>: switch antenna each 2 minute
*
*/
uint8_t wifi_config_set_antenna_diversity_timer_period_ex(uint8_t len, char *param[]);

/**
* @brief Example of Get antenna timer period.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get ant_timer_period
* \n <b>cli_output</b>:    output current antenna timer period
*
* \n <b>cli_example</b>:   wifi config get ant_timer_period
* \n <b>cli_note</b>:      return the current antenna timer period.
*
*/
uint8_t wifi_config_get_antenna_diversity_timer_period_ex(uint8_t len, char *param[]);


/**
* @brief Example of set switch antenna rssi threshold.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:  wifi config set ant_rssi_threshold <value>
* \n <b>cli_param</b>:   value:  switch antenna rssi threshold
*
* \n <b>cli_example</b>: wifi config set ant_rssi_threshold 2
* \n <b>cli_note</b>: if backup antenna rssi threshold - current rssi thoreshold > 2
* \n will switch to backup antenna
*
*/
uint8_t wifi_config_set_antenna_diversity_rssi_threshold_ex(uint8_t len, char *param[]);

/**
* @brief Example of Get antenna rssi thershold.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get ant_rssi_threshold
* \n <b>cli_output</b>:    output antenna rssi thrshold
*
* \n <b>cli_example</b>:   wifi config get ant_rssi_threshold
* \n <b>cli_note</b>:      return switch antenna rssi thrshold.
*
*/
uint8_t wifi_config_get_antenna_diversity_rssi_threshold_ex(uint8_t len, char *param[]);


/**
* @brief Example of set antenna switch short timer period.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:  wifi config set ant_short_period <value>
* \n <b>cli_param</b>:   value:  switch antenna short period
*
* \n <b>cli_example</b>: wifi config set ant_short_period 1
* \n <b>cli_note</b>: if current switch antenna failed, will switch again at next short period
*
*/
uint8_t wifi_config_set_antenna_diversity_short_period_ex(uint8_t len, char *param[]);

/**
* @brief Example of Get antenna switch short timer period.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get ant_short_period
* \n <b>cli_output</b>:    output antenna short antenna period
*
* \n <b>cli_example</b>:   wifi config get ant_short_period
* \n <b>cli_note</b>:      return antenna switch short timer period.
*
*/
uint8_t wifi_config_get_antenna_diversity_short_period_ex(uint8_t len, char *param[]);

/**
* @brief Example of set antenna beacon N number.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:  wifi config set ant_beacon_n_num <number>
* \n <b>cli_param</b>:   value:  antenna beacon N number
*
* \n <b>cli_example</b>: wifi config set ant_beacon_n_num 3
* \n <b>cli_note</b>: set beacon N number is 3
*
*/
uint8_t wifi_config_set_antenna_diversity_beacon_n_num_ex(uint8_t len, char *param[]);

/**
* @brief Example of Get antenna beacon N number.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get ant_beacon_n_num
* \n <b>cli_output</b>:    output antenna beacon N number
*
* \n <b>cli_example</b>:   wifi config get ant_beacon_n_num
* \n <b>cli_note</b>:      return antenna beacon N number.
*
*/
uint8_t wifi_config_get_antenna_diversity_beacon_n_num_ex(uint8_t len, char *param[]);

/**
* @brief Example of set antenna beacon T number.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:  wifi config set ant_beacon_t_num <number>
* \n <b>cli_param</b>:   value:  antenna beacon T number
*
* \n <b>cli_example</b>: wifi config set ant_beacon_t_num 3
* \n <b>cli_note</b>: set beacon T number is 3
*
*/
uint8_t wifi_config_set_antenna_diversity_beacon_t_num_ex(uint8_t len, char *param[]);

/**
* @brief Example of Get antenna beacon T number.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get ant_beacon_t_num
* \n <b>cli_output</b>:    output antenna beacon T number
*
* \n <b>cli_example</b>:   wifi config get ant_beacon_t_num
* \n <b>cli_note</b>:      return antenna beacon T number.
*
*/
uint8_t wifi_config_get_antenna_diversity_beacon_t_num_ex(uint8_t len, char *param[]);

/**
* @brief Example of set upper idle flag.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:   wifi config set ant_idle_flag <value>
* \n <b>cli_param</b>:   on/off:  0: busy;  1: idle
*
* \n <b>cli_example</b>: wifi config set ant_idle_flag 1
* \n <b>cli_note</b>: upper is idle
*
*/
uint8_t wifi_config_set_antenna_diversity_idle_flag_ex(uint8_t len, char *param[]);


/**
* @brief Example of Get upper idle flag.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get ant_idle_flag
* \n <b>cli_output</b>:    output upper idle flag
*
* \n <b>cli_example</b>:   wifi config get ant_idle_flag
* \n <b>cli_note</b>:      return upper idle flag.
*
*/
uint8_t wifi_config_get_antenna_diversity_idle_flag_ex(uint8_t len, char *param[]);

/**
* @brief Example of set antenna number.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:  wifi config set ant_num <number>
* \n <b>cli_param</b>:   number:  antenna numer
*
* \n <b>cli_example</b>: wifi config set ant_num 1
* \n <b>cli_note</b>: select antenna number
*
*/
uint8_t wifi_config_set_current_antenna_diversity_num_ex(uint8_t len, char *param[]);
/**
* @brief Example of Get antenna number.
*
* @return =0 means success, >0 means fail
*
* \n Example of cli usage
* \n <b>cli_format</b>:    wifi config get ant_num
* \n <b>cli_output</b>:    output current antenna number
*
* \n <b>cli_example</b>:   wifi config get ant_num
* \n <b>cli_note</b>:      return the current antenna number.
*
*/
uint8_t wifi_config_get_current_antenna_diversity_num_ex(uint8_t len, char *param[]);
#endif
