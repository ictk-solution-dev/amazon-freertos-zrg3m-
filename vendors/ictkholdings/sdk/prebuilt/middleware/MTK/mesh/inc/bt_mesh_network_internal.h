...
void Mesh_Network_ReceiveFromTransport_ex(uint8_t len, uint8_t *buf,
        ...
        uint16_t netkeyIdx, uint32_t ivindex, uint8_t credential_flag, uint8_t retry);

void Mesh_Network_ReceiveFromTransport(uint8_t len, uint8_t *buf,
                                       uint16_t src_addr, uint16_t dst_addr, bool ctl, uint8_t ttl, uint16_t netkeyIdx, uint32_t ivindex, uint8_t retry);
