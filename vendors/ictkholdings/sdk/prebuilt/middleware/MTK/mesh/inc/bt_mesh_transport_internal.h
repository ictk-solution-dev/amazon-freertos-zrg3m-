...
void Mesh_Upper_Transport_ComposeAccessPdu(uint8_t *key, uint8_t akfaid, uint8_t ttl,
        ...
        uint16_t netkeyIdx, uint8_t credential_flag);
...
void Mesh_Lower_Transport_receiveFromNetwork(mesh_network_pdu_params *netpdu, uint16_t netkeyIdx, bool isFromFriend);
