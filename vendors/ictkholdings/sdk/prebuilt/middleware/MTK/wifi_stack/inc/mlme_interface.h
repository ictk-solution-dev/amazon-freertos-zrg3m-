...
extern void wifi_set_sys_cfg_ext_to_wifi_stack();
...
extern int fw_mlme_enable_test_mode(void);

extern int fw_mlme_set_contiues_tx(uint8_t start, uint8_t modulation, uint8_t bw, uint8_t channel, uint8_t rate);
